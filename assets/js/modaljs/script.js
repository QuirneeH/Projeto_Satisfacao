...
const setorInputs = {
  inputs: [
    { placeholder: 'Nome do departamento', id: 'department', label: 'DEPARTAMENTO', type: 'text' },

    { placeholder: 'Digite o endereço', id: 'local', label: 'ENDEREÇO', type: 'text' },

    { placeholder: 'O que esse departamento faz?', id: 'description', label: 'DESCRIÇÂO', type: 'text' },
  ],
};
...
const localInputs = {
  inputs: [
    ...
    { placeholder: 'Digite a rua, bairro, cidade e estado', id: 'address', label: 'Endereço', type: 'text', required: true },
...
const usuarioInputs = {
  inputs: [
    ...
    { placeholder: 'Digite novamente sua senha', id: 'passwordConfirm', label: 'CONFIRMAR SENHA', type: 'password' },
